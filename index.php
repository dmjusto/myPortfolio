<!DOCTYPE html>
  <head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:600|PT+Sans|PT+Sans+Narrow:700|Roboto" rel="stylesheet">
...
<!-- Quote -->
    <article class="quoteSection">
      ...
      <section>
        ...
        <p><i class="fas fa-quote-left"></i> The world always seems brighter when you’ve just made something that wasn’t there before <i class="fas fa-quote-right"></i></p>
                  ...
                  <div id="hiddenContent_1" style="display: none" class="hiddenContent">
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        ...
                        <a href="https://store.steampowered.com/app/837280/Lost_Borderline/" title="See it on Steam"target="_blank" class="socialLink steamLink fab fa-steam"></a>
